    ...
    <div className=" mr-0 ">
      <div>
        <Anal className="">
          ...
          <Cost1 style={{ fontSize: "20px", paddingBottom: "10px" }}>
            Starting Year 2056
          </Cost1>
          <Track>
            <Cost1 style={{ marginRight: "35px" }}>
              $300,000<Desc> My Goal</Desc>
              <Hr />
            </Cost1>
            <Cost1 style={{ marginRight: "35px" }}>
              59%<Desc>Goal Achieved</Desc>
              <Hr />
            </Cost1>
            <Cost1 style={{ marginRight: "35px" }}>
              $300<Desc>Est. Monthly Income</Desc>
              <Hr />
            </Cost1>
          </Track>
          <Cost1 style={{ fontSize: "18px", paddingBottom: "10px" }}>
          ...
          >
            How do I comapare to my peers?
          </Cost1>
          <Desc style={{ marginLeft: "25px" }}>
