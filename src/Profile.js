...
function Profile(){
  return (
    <div className="">
      <div>
        <Profilesec className="">
          <TopSec>
            <Profilepic src="https://media.sproutsocial.com/uploads/2022/06/profile-picture.jpeg"></Profilepic>
            <Title>
              Hi Mike,<Welcome>welcome back</Welcome>
            </Title>
          </TopSec>
          ...
          <Cost3>Withdrawal Transfer to Bank-XXX11</Cost3>
          <Hr />
          <Desc>2020-08-07</Desc>
          <Cost3>Withdrawal Transfer to Bank-XXX11</Cost3>
          <Hr />
